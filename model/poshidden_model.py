...
class PosHidden(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.net_E = network.define_pos_textual_e(ngf=32, z_nc=256, img_f=256, layers=5, norm='none', activation='LeakyReLU',
