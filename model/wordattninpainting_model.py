...
class WordAttnInpainting(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.net_E = network.define_word_attn_e(ngf=32, z_nc=256, img_f=256, layers=5, norm='none', activation='LeakyReLU',
                          init_type='orthogonal', gpu_ids=opt.gpu_ids, image_dim=256, text_dim=256, multi_peak=False, pool_attention='max')
        self.net_G = network.define_hidden_textual_g(f_text_dim=256, ngf=32, z_nc=256, img_f=256, L=0, layers=5, output_scale=opt.output_scale,
