...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(1, _translate("Form", "bird_center"))
        self.comboBox.setItemText(2, _translate("Form", "place2_center"))
        self.comboBox.setItemText(3, _translate("Form", "coco_center"))
        self.comboBox.setItemText(4, _translate("Form", "flower_center"))
        self.comboBox.setItemText(5, _translate("Form", "bird_random"))
        self.comboBox.setItemText(6, _translate("Form", "place2_random"))
        self.comboBox.setItemText(7, _translate("Form", "coco_random"))
        self.comboBox.setItemText(8, _translate("Form", "flower_random"))
